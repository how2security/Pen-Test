...
echo "FQDN => Hosts Encontrados" >> $DIR/finderweb.aud
echo "=========================" >> $DIR/finderweb.aud
cat /tmp/$$.urls.2 >> $DIR/finderweb.aud
echo "N de Dominios encontrados: " `cat /tmp/$$.urls.2 | wc -l` >> $DIR/finderweb.aud
echo -e "\n" >> $DIR/finderweb.aud
...
echo "HOST2IP => Correlacionando os Hosts com os Enderecos IP Encontrados" >> $DIR/finderweb.aud
echo "==============================================================" >> $DIR/finderweb.aud
...
echo "IP => Extraindo os Enderecos IP dos Hosts Encontrados" >> $DIR/finderweb.aud
echo "=====================================================" >> $DIR/finderweb.aud
...
echo -e "\n"
echo -e "$verde""[+] Search results saved in: $DIR""$fim"
